...
class _Certificate_0 {
  alignment() {
    return _descriptor_8.alignment().concat(_descriptor_9.alignment().concat(_descriptor_6.alignment().concat(_descriptor_6.alignment().concat(_descriptor_10.alignment().concat(_descriptor_11.alignment())))));
  }
  fromValue(value_0) {
    return {
      id: _descriptor_8.fromValue(value_0),
      source: _descriptor_9.fromValue(value_0),
      generation: _descriptor_6.fromValue(value_0),
      vintage: _descriptor_6.fromValue(value_0),
      impact: _descriptor_10.fromValue(value_0),
      location: _descriptor_11.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_8.toValue(value_0.id).concat(_descriptor_9.toValue(value_0.source).concat(_descriptor_6.toValue(value_0.generation).concat(_descriptor_6.toValue(value_0.vintage).concat(_descriptor_10.toValue(value_0.impact).concat(_descriptor_11.toValue(value_0.location))))));
  }
}
...
class _QualifiedShieldedCoinInfo_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_6.alignment())));
  }
  fromValue(value_0) {
    return {
      nonce: _descriptor_0.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.nonce).concat(_descriptor_0.toValue(value_0.color).concat(_descriptor_2.toValue(value_0.value).concat(_descriptor_6.toValue(value_0.mt_index))));
  }
}
...
class _ShieldedSendResult_0 {
  alignment() {
    return _descriptor_15.alignment().concat(_descriptor_7.alignment());
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_15.toValue(value_0.change).concat(_descriptor_7.toValue(value_0.sent));
  }
}
...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_19.alignment().concat(_descriptor_7.alignment().concat(_descriptor_1.alignment().concat(_descriptor_0.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_19.toValue(value_0.domain_sep).concat(_descriptor_7.toValue(value_0.info).concat(_descriptor_1.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data))));
  }
}
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      mint: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(to_0).concat(_descriptor_2.toValue(tokenId_0).concat(_descriptor_12.toValue(tokenCertificate_0).concat(_descriptor_6.toValue(price_0)))),
            alignment: _descriptor_5.alignment().concat(_descriptor_2.alignment().concat(_descriptor_12.alignment().concat(_descriptor_6.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      setTokenPrice: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(tokenId_0).concat(_descriptor_6.toValue(price_0)),
      ...
      purchaseNFT: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(tokenId_0).concat(_descriptor_7.toValue(coin_0)),
                                                ...
                                                path: [
                                                       ...
                                                       { tag: 'value',
                                                         value: { value: _descriptor_2.toValue(tokenId_0),
                                                                  alignment: _descriptor_2.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(lifecycle_0),
                                                                                              alignment: _descriptor_6.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(seller_0),
                                                                                              alignment: _descriptor_5.alignment() }).encode() } },
  ...
  _addToPool_1(context, partialProofData, tokenId_0) {
    ...
    const tokenOwner_0 = _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                   ...
                                                                                   [
                                                                                    ...
                                                                                    { popeq: { cached: false,
                                                                                               result: undefined } }]).value);
    if (!this._equal_5(tokenOwner_0, callerAsEither_0)) {
      this._assertOnlyRole_1(context,
                             partialProofData,
                             __compactRuntime.convertFieldToBytes(32,
                                                                  2n,
        ...
        return {
          ...
          [Symbol.iterator](...args_1) {
            ...
            const self_0 = state.asArray()[1].asArray()[8].asMap().get({ value: _descriptor_2.toValue(key_0),
                                                                         alignment: _descriptor_2.alignment() });
            return self_0.asMap().keys().map(  (key) => {    const value = self_0.asMap().get(key).asCell();    return [      _descriptor_6.fromValue(key.value),      _descriptor_5.fromValue(value.value)    ];  })[Symbol.iterator]();
          }
        }
      }
    },
