...
describe('API', () => {
  ...
  it('public state provider testing', async () => {
    ...
    const state = PrivateBuyer.ledger(rawState1.data);
    ...
    const state2 = PrivateBuyer.ledger(rawState2.data);
    ...
    const state3 = PrivateBuyer.ledger(rawState3.data);
    ...
    const publicState = PrivateBuyer.ledger(rawState5[1].data);
    ...
    const state7 = PrivateBuyer.ledger(rawState7.data);
    logger.info({ state7 });
